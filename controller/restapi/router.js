...
let helper  = require('./features/fabric/helper');
let install = require('./features/fabric/install-chaincode');
let instantiate = require('./features/fabric/instantiate-chaincode');
let peer = require('./features/fabric/createPeer');
let fabricadmin = require('./features/fabric/app');
...
// router requests of fabric
router.post('/fabric/channel*', fabricadmin.channel);
router.post('/fabric/installChaincode*', fabricadmin.install);
router.post('/fabric/instantiate*', fabricadmin.instantiate);
router.post('/fabric/invoke*', fabricadmin.invoke);
router.get('/fabric/queryChaincode*', fabricadmin.queryChaincode);




// router requests for the fabric parts
router.get('/fabric/helper/getChannelForOrg*', helper.getChannelForOrg);
router.get('/fabric/helper/getClientForOrg*', helper.getClientForOrg);
router.get('/fabric/helper/getLogger*', helper.getLogger);
router.post('/fabric/helper/setupChaincodeDeploy*', helper.setupChaincodeDeploy);
router.get('/fabric/helper/getMspID*', helper.getMspID);
//router.get('/fabric/helper/ORGS*', helper.ORGS);
router.post('/fabric/helper/newPeers*', helper.newPeers);
router.post('/fabric/helper/newEventHubs*', helper.newEventHubs);
router.get('/fabric/helper/getRegisteredUsers*', helper.getRegisteredUsers);
router.get('/fabric/helper/getOrgAdmin*', helper.getOrgAdmin);

////////// install chaincode ///////////
//router.post('/fabric/installChaincode*', install.installChaincode);
//router.post('/fabric/installChaincode*', install.inst);


//////// initiate chaincode ////////
//router.post('/fabric/instantiateChaincode*',instantiate.instantiateChaincode);
router.post('/fabric/createPeer*', peer.createPeer);
