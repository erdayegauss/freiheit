...
var config = require('/Users/shuan/Documents/blockchain/HyperledgerComposer/pershing/controller/env.json');
...
var createChannel = function(channelName, channelConfigPath, username, orgName) {
	...
	logger.debug('The orgName is: '+orgName);
	logger.debug('The client is: '+client);
...
// createChannel("channeltest", "/Users/shuan/Documents/blockchain/HyperledgerComposer/pershing/tools/deploy/channeltest.tx", "someone", "org1");
