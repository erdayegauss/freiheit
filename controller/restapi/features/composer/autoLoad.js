                    ...
                    .then(function(participantRegistry){
                        ...
                        .catch((error) => {
                            ...
                            .then(() => {
                                ...
                                // here is the trick, _arr[_idx].id plus a Card as the identity name, otherwise there is err that identity is already in

                                return businessNetworkConnection.issueIdentity(config.composer.NS+'.'+_arr[_idx].type+'#'+_arr[_idx].id, _arr[_idx].id + "Card")
                                .then((result) => {
