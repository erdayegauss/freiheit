...
//app.use('/fabric/', require("./controller/restapi/features/fabric/fabric"));



/////// here is the new function test yard//////////
/////// the main issue of the installation is the env setting, it is necessary to have a universal env setting ////////
////// this should be set as the first priority//////////////


/*
var install=require("./controller/restapi/features/fabric/install-chaincode.js");

var peers=["peer1"];
var chaincodeName="mycc";
var chaincodePath="github.com/example_cc";
var chaincodeVersion="v1";
var username="admin";
var org="org1";
